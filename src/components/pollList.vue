<template>
  <div class="pollHome">
          ...
          <div class="poll" v-for="poll in polls" :key="poll.id">
              <div class="pollHead">
                  ...
                  <div class="pollIcons">
                      ...
                      <span @click="showPoll(polls.indexOf(poll))"><i class="fa fa-pen"></i></span>
                  </div>
              </div>
              <div class="pollOptions" v-for="option in poll.optionList" :key="option.Id">
                  ...
                  countVote(poll.options.indexOf(option), polls.indexOf(poll), isChecked)" />
      ...
      <div class="addPoll">
          <button class="addPollBtn" @click="showAddPoll">
              Add a new poll
          </button>
      </div>
  </div>
...
export default {
  name: "pollList",
  setup() {
      const { polls, showAddPoll, isState, showPoll, handleScroll, scrollComponent } = pollApi()
      ...
      return { polls, showAddPoll, isState, showPoll ,scrollComponent }
  },
};
</script>